...
function getArtistByIndex(artarr, i) {
  return `the artist at index ${i} is ${artarr[i].name}`
}
...
function artistInfo(artarr, name){
  return artarr[
    artarr.findIndex((i) => {
      return i.name === name
  })].bio;
